			...
			<div class="animated fadeIn">
				...
				<div class="row">
					<div class="col-sm-12 col-md-12">
						<div class="dataTables_paginate paging_simple_numbers pagintion"
									...
									id="bootstrap-data-table-export_previous"><c:choose>
										<c:when test="${currentPage > 1}">
											<c:if test="${keyword!=null}">
												<a href="/admin/servicedetails?page=1&keyword=${keyword}"
	...
	<script>
		...
		$('.service-id').change(function(){
			...
			if(serviceID === 'Services'){
				...
				window.location = '/admin/servicedetails?page=1&keyword=' + serviceID;
			}
		})
	</script>
</body>
