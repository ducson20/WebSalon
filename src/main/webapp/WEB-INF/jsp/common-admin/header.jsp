					...
					<div class="dropdown-menu" aria-labelledby="message">
						...
						<a class="dropdown-item media bg-flat-color-1" href="#"> <span
							class="photo media-left"><img alt="avatar"
								src="<% request.getContextPath(); %>/images/avatar/1.jpg"></span> <span
							...
							class="photo media-left"><img alt="avatar"
								src="<% request.getContextPath(); %>/images/avatar/2.jpg"></span> <span
							...
							class="photo media-left"><img alt="avatar"
								src="<% request.getContextPath(); %>/images/avatar/3.jpg"></span> <span
							...
							class="photo media-left"><img alt="avatar"
								src="<% request.getContextPath(); %>/images/avatar/4.jpg"></span> <span
		...
		<div class="col-sm-5">
			<div class="user-area dropdown float-right">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown"
					...
					class="user-avatar rounded-circle" src="<% request.getContextPath(); %>/images/admin.jpg"
					alt="User Avatar">
				</a>
